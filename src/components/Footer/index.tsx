        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[380px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a href="mailto:usa@tsmart.ai" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li className="flex gap-4.5">
                ...
                <div>
                  ...
                  <div className="text-sm">17-09 Zink Place Suite #4<br/>Fair Lawn, 07410 New Jersey, USA</div>
                </div>
              </li>
              ...
              <li className="flex gap-4.5">
                ...
                <div>
                  <div className="font-medium mb-1">HQ</div>
                  <div className="text-sm">TALYA SMART DATA MANAGEMENT TECHNOLOGIES L.L.C<br/>Dubai Science Park Al-Barsha South C17<br/>Dubai, UAE</div>
                </div>
              </li>
            </ul>
          ...
          <div className="flex gap-5 flex-wrap items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <a href="#" aria-label="payment system with bank transfer" className="flex items-center gap-2 px-3 py-1 border border-gray-3 rounded">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
