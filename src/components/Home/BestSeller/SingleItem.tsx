...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group bg-white rounded-lg shadow-1 overflow-hidden">
      ...
      <div className="relative overflow-hidden w-full aspect-square bg-gray-1">
        {imageUrl ? (
          <Image
            src={imageUrl}
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-4">
            <svg
