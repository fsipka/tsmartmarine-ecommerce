...
const MyAccount = () => {
  ...
  useEffect(() => {
    // Session kontrolü - eğer login değilse signin'e yönlendir
  ...
  const fetchOrders = async () => {
    ...
    try {
      const data = await orderService.getAllWithDetails();
      setOrders(data);
    } catch (error: any) {
  ...
  // Session yoksa gösterme (redirect olacak)
  if (!isAuthenticated || !user) {
    return null;
  }
                ...
                <div className="hidden lg:flex flex-wrap items-center gap-5 py-6 px-4 sm:px-7.5 xl:px-9 border-r xl:border-r-0 xl:border-b border-gray-3">
                  <div className="max-w-[64px] w-full h-16 rounded-full overflow-hidden">
                    {user.imageUrl ? (
                      ...
                      <div className="w-16 h-16 bg-blue rounded-full flex items-center justify-center text-white text-xl font-bold">
                  ...
                  <div>
                    ...
                    <p className="text-custom-xs">{user.companyName}</p>
                  </div>
                </div>
