...
import AccessoryCategoryDropdown from "./AccessoryCategoryDropdown";

const ShopAccessorySidebar = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        console.log('Accessory products:', accessories);
        if (accessories.length > 0) {
          console.log('First accessory:', accessories[0]);
        }
  ...
  return (
    <>
      <Breadcrumb title="Accessories" pages={["home", "shop"]} />
            ...
            <div className="flex-1">
              ...
              {loading ? (
                ...
                <div className="bg-white rounded-[10px] shadow-1 py-20 text-center">
                  <p className="text-gray-4 text-lg">No accessories found</p>
                </div>
              ) : (
                <div
                  className={
...
export default ShopAccessorySidebar;
