...
const Cart = () => {
  ...
  return (
    <>
      ...
      <section>
        <Breadcrumb title={t("common.cart")} pages={[t("common.cart")]} />
      </section>
      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              ...
              <button className="text-blue">{t("cart.clearCart") || "Clear Shopping Cart"}</button>
            </div>
                ...
                <div className="min-w-[1170px]">
                  ...
                  <div className="flex items-center py-5.5 px-7.5">
                    <div className="min-w-[400px]">
                      <p className="text-dark">{t("cart.productName")}</p>
                    </div>
                    ...
                    <div className="min-w-[200px]">
                      <p className="text-dark">{t("cart.subtotal")}</p>
                    </div>

                    <div className="min-w-[50px]">
                      <p className="text-dark text-right">{t("account.actions")}</p>
                    </div>
                  </div>
        ...
        <>
          <div className="text-center mt-8">
            ...
            <p className="pb-6">{t("cart.emptyCart")}</p>
